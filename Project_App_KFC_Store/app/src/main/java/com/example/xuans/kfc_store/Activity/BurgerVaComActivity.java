...
public class BurgerVaComActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView gridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.burgervacom_main);
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.tb_burgervacom_main);
        gridView = findViewById(R.id.grid_burgervacom_main);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_actionbar_tongdaivien:
                AlertDialog.Builder builder= new AlertDialog.Builder(BurgerVaComActivity.this);
            ...
            case R.id.menu_actionbar_giohang:
                Intent intent = new Intent(BurgerVaComActivity.this,GioHangActivity.class);
                startActivity(intent);
                Toast.makeText(BurgerVaComActivity.this,"Giỏ Hàng",Toast.LENGTH_LONG).show();
                return true;
        }
