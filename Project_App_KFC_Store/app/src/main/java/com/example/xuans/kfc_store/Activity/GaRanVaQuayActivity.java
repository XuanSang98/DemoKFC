...
public class GaRanVaQuayActivity extends AppCompatActivity {
    Toolbar tb_garanvaquay;
    ListView list_garanvaquay;
    ThucDonAdapter gaRanVaQuayAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.garanvaquay_main);
        if(CheckConnection.haveNetworkConnection(getApplicationContext())){
            ...
            CheckConnection.ShowToas_Short( getApplicationContext(),"KKiem Tra Ket Noi");
        }
    }
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_actionbar_tongdaivien:
                AlertDialog.Builder builder= new AlertDialog.Builder(GaRanVaQuayActivity.this);
            ...
            case R.id.menu_actionbar_giohang:
                Intent intent = new Intent(GaRanVaQuayActivity.this,GioHangActivity.class);
                startActivity(intent);
                Toast.makeText(GaRanVaQuayActivity.this,"Giỏ Hàng",Toast.LENGTH_LONG).show();
                return true;
        }
    ...
    private void LoadMoreData() {
        list_garanvaquay.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        list_garanvaquay.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        StringRequest stringRequest= new StringRequest(Request.Method.POST, duongan, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response!=null && response.length()!=2){
                    list_garanvaquay.removeFooterView(footerview);
                    ...
                    try {
                        ...
                        for (int i=0;i<array.length();i++) {
                            ...
                            gaRanVaQuayAdapter.notifyDataSetChanged();
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("ID_ThucDon",String.valueOf(ID));
                return param;
            }
        };
    ...
    private void AnhXa(){
        tb_garanvaquay = findViewById(R.id.tb_garanvaquay_main);
        list_garanvaquay = findViewById(R.id.list_garanvaquay_main);
        chiTietThucDons = new ArrayList<>();
        gaRanVaQuayAdapter = new ThucDonAdapter(getApplicationContext(),chiTietThucDons);
        list_garanvaquay.setAdapter(gaRanVaQuayAdapter);
    ...
    public class mHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    list_garanvaquay.addFooterView(footerview);
                    break;
                case 1:
                    getData(++page);
                    isLoading=false;
    ...
    private void Actionbar() {
        setSupportActionBar(tb_garanvaquay);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        tb_garanvaquay.setNavigationIcon(R.drawable.back);
        tb_garanvaquay.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
