...
public class PhanAnComBoActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView gridView;
    ThucDonAdapter phanAnComBoAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phanancombo_main);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_actionbar_tongdaivien:
                AlertDialog.Builder builder= new AlertDialog.Builder(PhanAnComBoActivity.this);
            ...
            case R.id.menu_actionbar_giohang:
                Intent intent = new Intent(PhanAnComBoActivity.this,GioHangActivity.class);
                startActivity(intent);
                Toast.makeText(PhanAnComBoActivity.this,"Giỏ Hàng",Toast.LENGTH_LONG).show();
                return true;
        }
              ...
              if(response!=null && response.length()!=2){
                  ...
                  try {
                      ...
                      for (int i=0;i<array.length();i++) {
                          ...
                          phanAnComBoAdapter.notifyDataSetChanged();
                      }
    ...
    private void AnhXa(){
        toolbar = findViewById(R.id.tb_phanancombo_main);
        gridView = findViewById(R.id.grid_phanancombo_main);
        chiTietThucDons = new ArrayList<>();
        phanAnComBoAdapter = new ThucDonAdapter(getApplicationContext(),chiTietThucDons);
        gridView.setAdapter(phanAnComBoAdapter);
