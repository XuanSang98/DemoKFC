...
public class ThucAnNheActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView gridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thucannhe_main);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_actionbar_tongdaivien:
                AlertDialog.Builder builder= new AlertDialog.Builder(ThucAnNheActivity.this);
            ...
            case R.id.menu_actionbar_giohang:
                Intent intent = new Intent(ThucAnNheActivity.this,GioHangActivity.class);
                startActivity(intent);
                Toast.makeText(ThucAnNheActivity.this,"Giỏ Hàng",Toast.LENGTH_LONG).show();
                return true;
        }
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.tb_thucannhe_main);
        gridView = findViewById(R.id.grid_thucannhe_main);
